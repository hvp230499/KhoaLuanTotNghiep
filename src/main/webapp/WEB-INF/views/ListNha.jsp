...
<html>
  ...
  <body>
    ...
    <div class="container mt-1">
      <h2>Danh sách nhà nguyên căn khả dụng</h2>
      <hr />
      <div class="row row-cols-1 row-cols-md-2">
      <c:if test="${listnha.size()==0}">
				<div class="col-12"><h4>Không tìm thấy phòng trọ nào!</h4></div>
		</c:if>
      <c:forEach items="${listnha}" var="phongtro">
      	<div class="col mb-4">
          <a href="${pageContext.request.contextPath}/detail/${phongtro.getPostID()}">
            <div class="card" style="height: 470px">
              <img
                src="data:image/jpeg;base64,${phongtro.getImages().get(0).getStringImage()}"
                class="card-img-top"
                alt="${phongtro.getImages().get(0).getName()}"
                height="300px"
              />
              <div class="card-body">
                ...
                <h6>
                  ...
                  ${phongtro.getDiaChi()}, ${phongtro.getXa() }, ${phongtro.getHuyen()}, ${phongtro.getTinh() }
                </h6>
